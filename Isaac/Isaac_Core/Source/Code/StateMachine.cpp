...
namespace Core
{
  ...
  void CStateMachine::mp_InitCurrentState(sf::Event av_Event)
  {
    ...
    std::pair< std::shared_ptr<const Foundation::Interfaces::IState >, std::string> lv_StateAndTrigger = mv_xStateOrchestrator->mf_xGetStateToBeDisplayed(lv_bCheckForAutomaticBlock, av_Event);
