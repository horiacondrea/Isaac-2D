  ...
  */
  namespace Interfaces
  {
    ...
    public:
      ...
      virtual const std::shared_ptr<const Interfaces::IState>& mf_xGetStateByName(std::string) const = 0;
    ...
    protected:
      ...
      virtual void mp_AddState(const std::shared_ptr<const Interfaces::IState>&) const = 0;
