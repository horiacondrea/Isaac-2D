  ...
  */
  namespace Interfaces
  {
    ...
    public:
      ...
      virtual void mp_Release(std::shared_ptr<const Interfaces::ITransientData>& av_xTransientData, std::string ac_szTriggerName) = 0;
    ...
    protected:
      IStaticState(std::string ac_szStateName) : IState(ac_szStateName)
      {
        ;
      }
