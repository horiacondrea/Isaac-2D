...
namespace Foundation
{
  ...
  public:
    ...
    bool mf_bRemoveTrigger(const CString& ac_szTriggerIdentifier);

    const std::shared_ptr<const Foundation::Interfaces::ITrigger>& mf_xGetTriggerByName(const CString& ac_szTriggerIdentifier) const;
