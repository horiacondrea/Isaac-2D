...
DynamicState::DynamicState(const CString& ac_szStateName) :
...
void DynamicState::mp_DefineProcess() const
{
  ...
  std::shared_ptr<const Foundation::Interfaces::ITrigger> t1 = std::make_shared<const Triggers::CElementPositionTrigger>(Triggers::en_GraterThen, _T("tpe"));

  std::shared_ptr<const Foundation::Interfaces::ITrigger> t2 = std::make_shared<const Triggers::CElementPositionTrigger>(Triggers::en_GraterThen, _T("tpe2"));
